...
// CRIANDO UM FUNÇAO PARA PRODUTO CONTER ATUALIZAÇÃO
func (p Produto) String() string {
	...
	//SE NÃO DER ERRO MOSTRO O VALOR
	return string(data)
}

// ESPECIFICANDO O TIPO DE CONTEUDO DE PRODUTO E TRANSFORMANDO EM JSONE
...
// ESPECIFICANDO O TIPO DE CONTEUDO DE USUARIO TRANSFORMANDO EM JSONE
type User struct {
